...
![图片](/images/blog/recommendations/28.jpg)

这里配置完毕后需要等待一会，等dns解析完毕，才能进入到后续步骤

![图片](/images/blog/recommendations/29.jpg)
...
![图片](/images/blog/recommendations/31.jpg)

![图片](/images/blog/recommendations/32.jpg)
...
![图片](/images/blog/recommendations/33.jpg)

![图片](/images/blog/recommendations/34.jpg)

接着点击右下角的激活按钮；

2.添加域名如下：如www\.mydomain.com

![图片](/images/blog/recommendations/35.jpg)

![图片](/images/blog/recommendations/36.jpg)

这2个域名的配置都配置好之后，等待域名激活。如下：激活完毕后，我们就可以使用前面购买的域名来访问前面说的页面了！

![图片](/images/blog/recommendations/37.jpg)

使用mydomain.com域名访问我的网站如下：

![图片](/images/blog/recommendations/38.jpg)
...
如果你在部署过程中有任何疑问，都可以在评论区留言，我们一起讨论和解决。

你的支持是我持续创作的最大动力。如果觉得本文对你有帮助，请不吝**点赞、分享和在看**。
